...
var _Inject = require('./modules/Inject');
...
if ((0, _jquery2.default)('[data-inject]').length) {
  (0, _jquery2.default)('[data-inject]').each(function (i, el) {
    new _Inject2.default(el);
  });
}

if ((0, _jquery2.default)('[data-movies]').length) {
  (0, _jquery2.default)('[data-movies]').each(function (i, el) {
    new _Movies2.default(el);
  });
}

},{"./modules/Inject":2,"./modules/Movies":3,"./modules/SVGInjector":4,"jquery":25}],2:[function(require,module,exports){
'use strict';
...
var Inject = function () {
  function Inject(el) {
    ...
    this.$button = (0, _jquery2.default)(el);
    this.events();
  }
  ...
  _createClass(Inject, [{
    ...
    key: 'fetchAsset',
    value: function fetchAsset(ev) {
      var url = (0, _jquery2.default)(ev.currentTarget).data('inject');
      this.appendAsset(url);
    }
  }, {
    key: 'appendAsset',
    value: function appendAsset(url) {
      var image = (0, _jquery2.default)('<img>').attr('src', url).on('load', function () {
        (0, _jquery2.default)('body').append(image);
      });
    }
  }]);
...
var _movies = require('../templates/movies.hbs');
...
var Movies = function () {
  ...
  _createClass(Movies, [{
    ...
    key: 'fetchAsset',
    value: function fetchAsset(ev) {
      var url = (0, _jquery2.default)(ev.currentTarget).data('movies');
      this.retrieveData(url);
    }
  }, {
    key: 'retrieveData',
    value: function retrieveData(url) {
      _jquery2.default.get(url).done(this.appendData);
    }
  }, {
    key: 'appendData',
    value: function appendData(data) {
      (0, _jquery2.default)('body').append((0, _movies2.default)(data));
    }
  }]);
...
},{"../templates/movies.hbs":5,"jquery":25}],4:[function(require,module,exports){
'use strict';
...
},{"svg-injector":26}],5:[function(require,module,exports){
var templater = require("handlebars/runtime")["default"].template;module.exports = templater({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div>\n    <h2>"
    + alias4(((helper = (helper = helpers.show_title || (depth0 != null ? depth0.show_title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"show_title","hash":{},"data":data}) : helper)))
    + "</h2>\n    <h4>Released "
    + alias4(((helper = (helper = helpers.release_year || (depth0 != null ? depth0.release_year : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"release_year","hash":{},"data":data}) : helper)))
    + "</h4>\n    <p>"
